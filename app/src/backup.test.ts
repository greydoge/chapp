...
describe("workspace backup helpers", () => {
  it("round-trips a backup envelope", () => {
    const settings: WorkspaceBackupSettings = {
      ...
      xmppWebSocketUrl: "wss://chat.example.com/xmpp-websocket",
      xmppJid: "user@example.com",
      xmppPassword: "secret",
      xmppRoomJid: "room@conference.example.com",
      xmppSpaceServiceJid: "spaces.movim.eu",
      xmppSpaceNode: "G4OyS0LK",
      xmppNick: "Ada",
      chatPaneChannels: ["lobby", "lobby", "lobby"],
      ...
      recentEmojis: ["👍"],
      pronouns: "they/them",
      pronunciation: "dee-uh-nuh",
      hobbies: "music, hiking, coffee",
      languages: "English, French",
      company: "Relayless",
      school: "University of Toronto",
      major: "Computer Science",
      accentColor: "#7c8cff",
      statusMessage: "Working on the build",
      website: "https://example.com",
      location: "Toronto, CA",
      headline: "Builder, ops, night shift",
      timezone: "UTC-4",
      birthday: "Jan 1",
    };
